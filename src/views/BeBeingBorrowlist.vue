<template>
  ...
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item style="font-size: 20px;">正在借款</el-breadcrumb-item>
    </el-breadcrumb>
    <br>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column label="操作" width="200">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="danger" @click="handle(scope.$index, scope.row,2)">撤标</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<!--    撤标-->
    <el-dialog style="font-size: 20px;width:1400px" :title="edit.titles" :visible.sync="dialogMergeFormVisible1">
      <el-form :label-position="labelPosition" label-width="80px"   status-icon  status-icon :model="SIssue" class="demo-form-inline">
        <el-form-item label="撒标理由">
          <el-input type="textarea" placeholder="撒标理由" v-model="SIssue.siReason"></el-input>
        </el-form-item>
        <el-form-item label="管理备注">
          <el-input type="textarea" placeholder="管理备注" v-model="SIssue.siAdministration"></el-input>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      handleEdit(index, row) {
        ...
        this.siState1=true;
        this.siState2= false;
        this.SIssue.siState='借贷中';
        // this.confirm=false;
      },
      // 确定是否撤标
      handleupdate(index, row) {
        this.edit.titles='确定是否撤标';
        this.SIssue.siState='5';
