<template>
  ...
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item style="font-size: 20px;">发标待审核</el-breadcrumb-item>
    </el-breadcrumb>
    <br>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column label="操作" width="200">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="danger" @click="handle(scope.$index, scope.row,2)">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<!--        </el-form-item>-->
      ...
      <div slot="footer" class="dialog-footer">
        <el-button v-if="confirm" type="primary" @click="doupdate">确定</el-button>
