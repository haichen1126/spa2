<template>
  ...
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item style="font-size: 20px;">满标待审核</el-breadcrumb-item>
    </el-breadcrumb>
    <br>
    ...
    <el-dialog style="font-size: 20px;width:1400px" :title="edit.titles" :visible.sync="dialogMergeFormVisible">
      <el-form :label-position="labelPosition" label-width="80px"   status-icon :inline="true" status-icon :model="SIssue" class="demo-form-inline">
        ...
        <el-form-item label="状态">
          ...
          <el-radio  v-if="siState2"  v-model="SIssue.siAudit" value="2" label="2">审核通过</el-radio>
          <el-radio v-if="siState2" v-model="SIssue.siAudit" value="1" label="1">审核不通过</el-radio>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      handle(index, row,a){
        ...
        console.log(row.siDeadline)
        this.SIssue.siDeadline=row.siDeadline;
        this.SIssue.bsType=row.bSign.bsType;
        this.SIssue.twName=row.tWay.twName;
        this.SIssue.siSubmit=row.siSubmit;
        this.SIssue.twId=row.tWay.twId;
        this.SIssue.suiRental=row.sUserInformation.suiRental;
        this.SIssue.siSuiId=row.siSuiId;
